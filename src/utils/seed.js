...
const servicesData = [
  ...
  },
  {
    ...
    fullDesc:
      "End-to-end digital solutions including e-commerce setup and CSV automation.",
    features: [
  ...
  },
  {
    ...
    fullDesc:
      "Visually compelling interfaces that convert visitors into customers.",
    features: [
  ...
  },
  {
    ...
    fullDesc:
      "Boost online visibility through targeted strategies and data-driven decisions.",
    features: [
...
const portfolioData = [
  {
    ...
    category: "E-commerce",
    description:
      "Managed and uploaded over 5,000 product listings to a Shopify store with images, variants, and SEO metadata.",
  ...
  },
  {
    ...
    category: "Automation",
    description:
      "Built a streamlined CSV import pipeline for WooCommerce handling complex attributes and inventory syncing.",
  ...
  },
  {
    ...
    category: "E-commerce",
    description:
      "Custom variant mapping for a fashion brand across sizes, colors, and materials.",
  ...
  },
  {
    ...
    category: "Automation",
    description:
      "Automated bulk product management syncing inventory, pricing across multiple platforms.",
    tags: ["Python", "API", "Automation"],
    result: "Automated 10,000+ SKUs",
    duration: "10 days",
    order: 4,
  },
  {
    ...
    description:
      "Custom Shopify theme with unique animations, fast load times, and mobile-first design.",
  ...
  },
  {
    ...
    category: "Web Development",
    description:
      "Multi-vendor marketplace with vendor onboarding, commission management, and order routing.",
...
const testimonialsData = [
  {
    ...
    rating: 5,
    review:
      "Excellent work on Shopify product uploads. Very professional and fast delivery.",
    order: 1,
  },
  {
    name: "Sarah Wilson",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "Outstanding web development skills. The website looks fantastic and loads super fast.",
    order: 4,
  },
  {
    name: "Ahmed Hassan",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "The variant mapping solution was exactly what we needed. Clean code, great communication, on time.",
    order: 6,
  },
];
...
const pricingData = [
  {
    ...
    notIncluded: ["Variant mapping", "Automation scripts"],
    order: 1,
  },
  {
    name: "Standard",
  ...
  },
  {
    ...
    price: "$349",
    duration: "7–14 Days",
    desc: "Full-service for large stores.",
    popular: false,
    color: "#8b5cf6",
    features: [
  ...
  timeline: [
    {
      ...
      desc: "Managing Shopify & WooCommerce stores, bulk automation, and web development for global clients.",
    },
    {
      year: "2022 – 2024",
      role: "E-commerce Manager",
      company: "Digital Commerce Agency",
      desc: "Led product data migrations, 50,000+ uploads, CSV automation for 20+ clients.",
    },
    {
      year: "2020 – 2022",
      role: "Shopify Developer & Data Analyst",
      company: "Freelance (Fiverr & Upwork)",
      desc: "Shopify store setup, variant mapping, WooCommerce customization for international clients.",
    },
    {
      year: "2019 – 2020",
      role: "Web Developer",
      company: "Local IT Company, Pakistan",
      desc: "Built WordPress websites and developed e-commerce fundamentals.",
    },
  ],
  certifications: [
